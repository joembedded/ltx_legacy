...
<?php
	...
	$xc=$crc&255;
	$res=""; for($i=0;$i<6;$i++) $res.=chr(ord($plain{$i})^(($i*15+$xc)&255));
	...
	for($i=0;$i<$anz;$i++){
		echo "<table>";
		echo "<tr style='font-size:120%; font-weight:bold;'><td>Device MAC:</td><td>$mac</td><td rowspan='3' style='margin:0; padding:0;' ><img src='$qrlink'></td></tr>";
